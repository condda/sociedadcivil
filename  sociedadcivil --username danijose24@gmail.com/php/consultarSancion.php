<?php
	...
	$pnlcontent = new Panel("../html/consultarSancion.html");
	$pnlcontent->add("nombre","Sanciones");
	$pnlcontent->add("crear",'<a href="crearSancion.php">Crear Sancion</a>');
	$pnlcontent->add("consultar",'<a href="consultarSancion.php">Consultar Sancion</a>');
