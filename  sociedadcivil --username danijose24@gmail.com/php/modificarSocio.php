...
if($cedula!=NULL)
	{
			...
			if($modificar == 1)
			{
				...
				$result =  mysql_query ("SELECT * FROM beneficiario B, Socio_Beneficiario SF WHERE SF.cedulaPersona = '$cedula' AND SF.cedulaBeneficiario = B.cedulaBeneficiario");
	...
	$result =  mysql_query ("SELECT * FROM persona P, socio S where S.cedulaPersona = P.cedulaPersona ");
