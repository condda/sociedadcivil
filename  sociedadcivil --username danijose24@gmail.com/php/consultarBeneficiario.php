<?php
	...
	$pnlcontent = new Panel("../html/consultarBeneficiario.html");
	
	$consultarCodigo = $_REQUEST['consultarCedula'];
	if ($consultarCedula){
		...
		if (!$result1){
			...
			$pnlcontent->add("consultarCedula",$consultarCedula);					
		}
	}
	else{
	...
	while ($result1 = mysql_fetch_assoc($result)){
		...
		<td><a href="../php/fConsultarBeneficiario.php?cedulabeneficiario='.$result1['cedulaBeneficiario'].
		'&cedulapersona='.$result1['cedulaPersona'].'">Consultar</a></td></tr>';
	}
	$pnlcontent->add("consultarBeneficiario",$listaBeneficiario);
