<?php
	...
	echo '<tr>
      ...
      <td width="116" valign="middle"'.$fondo.'><input type="button" name="button" id="button" value="Aceptar" onclick="finalizarModJD('.$idJuntadirectiva.','.$flag.')" /></td>
    </tr>';
	...
	if ($idTribunald){
		...
		$result = mysql_query("select * from tribunald where idTribunald = '$idTribunald'");
		$fondo = 'bgcolor="#CCCCCC"';
		...
		echo '<tr>
      	<td width="175" valign="middle" '.$fondo.'><input name="nombreCargo" type="text" id="nombreCargo" value="'.$result1['nombre'].'" maxlength="35" /></td>
      
      <td width="116" valign="middle"'.$fondo.'><input type="button" name="button" id="button" value="Aceptar" onclick="finalizarModTD('.$idTribunald.','.$flag.')" /></td>
    	</tr>';
