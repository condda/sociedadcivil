<?php
	...
	$pnlcontent->add("nombre","Cargos Tribunal Disciplinario");
	$pnlcontent->add("crear",'<a href="crearCargoTD.php">Crear Cargo</a>');
	$pnlcontent->add("consultar",'<a href="consultarCargoTD.php">Consultar Cargo</a>');
